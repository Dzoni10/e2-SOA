...
type BlogServiceClient interface {
	...
	GetAllBlogs(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BlogListResponse, error)
...
func (c *blogServiceClient) GetAllBlogs(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BlogListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BlogServiceServer interface {
	...
	GetAllBlogs(context.Context, *Empty) (*BlogListResponse, error)
...
func (UnimplementedBlogServiceServer) GetAllBlogs(context.Context, *Empty) (*BlogListResponse, error) {
...
func _BlogService_GetAllBlogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).GetAllBlogs(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
